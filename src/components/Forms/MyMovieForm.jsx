...
const MyMovieForm = () => {
    ...
    const handleNavigateToAddActor = () => {
        navigate('/addActor'); // Update this route to your actual add actor page
    };

    const handleNavigateToAddProducer = () => {
        navigate('/addProducer'); // Update this route to your actual add producer page
    };
                    ...
                    <>
                        <div className="mb-3">
                            ...
                            <div className="d-flex align-items-center">
                                <select
                                    className="form-select me-2" // Add margin end to separate from the button
                                    onChange={(e) => {
                                        const selectedProducer = e.target.value;
                                        if (selectedProducer && !movie.producers.includes(selectedProducer)) {
                                            setMovie(prev => ({ ...prev, producers: [...prev.producers, selectedProducer] }));
